...
#if !defined(AFX_COMMANDS_H__DEACBAD8_24DD_11D2_A392_444553540000__INCLUDED_)
#define AFX_COMMANDS_H__DEACBAD8_24DD_11D2_A392_444553540000__INCLUDED_

#include "WorkspaceUtilsTypes.h"
#include "WorkspaceInfo.h"
#include "FindFileDialog.h"

class CCommands :
	public CComDualImpl<ICommands, &IID_ICommands, &LIBID_WorkspaceUtils>,
...
protected:
	...
	class XApplicationEvents : public XEventHandler<IApplicationEvents,
		&IID_IApplicationEvents, &LIBID_WorkspaceUtils,
	...
	class XDebuggerEvents : public XEventHandler<IDebuggerEvents,
		&IID_IDebuggerEvents, &LIBID_WorkspaceUtils,
	...
	bool GetActiveFile(CString& activeFile);

public:
// ICommands methods
	STDMETHOD(WUFileOpen)();
	STDMETHOD(WUHeaderFlip)();
	STDMETHOD(WUFindTagDlg)();
	STDMETHOD(WUCompilerFileOpen)();
	STDMETHOD(WUFindTagAtCursor)();
	STDMETHOD(WUFindTagAtCursorDlg)();
	STDMETHOD(WUFindPrevTag)();
	STDMETHOD(WUFindNextTag)();
	STDMETHOD(WUFindPrevFile)();
	STDMETHOD(WUFindNextFile)();
	STDMETHOD(WUFixMultiplePrecompiledHeaders)();
};
...
#endif // !defined(AFX_COMMANDS_H__DEACBAD8_24DD_11D2_A392_444553540000__INCLUDED)
