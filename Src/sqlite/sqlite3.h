...
/*
** Write a ":memory:" database "db" to the file given by "szFilename". Resulting
** file is a full functional sqlite3-database.
*/
int sqlite3_write_to_file(sqlite3 *db, const char *szFilename);
