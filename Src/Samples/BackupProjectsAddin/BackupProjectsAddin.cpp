///////////////////////////////////////////////////////////////////////////////
// $Workfile: BackupProjectsAddin.cpp $
...
/////////////////////////////////////////////////////////////////////////////
// CBackupProjectsAddinApp

class CBackupProjectsAddinApp : public CWinApp
{
public:
	CBackupProjectsAddinApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CBackupProjectsAddinApp)
	public:
	virtual BOOL InitInstance();
	virtual int ExitInstance();
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CBackupProjectsAddinApp)
...
BEGIN_MESSAGE_MAP(CBackupProjectsAddinApp, CWinApp)
	//{{AFX_MSG_MAP(CBackupProjectsAddinApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CBackupProjectsAddinApp object

CBackupProjectsAddinApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CBackupProjectsAddinApp construction

CBackupProjectsAddinApp::CBackupProjectsAddinApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// CBackupProjectsAddinApp initialization

BOOL CBackupProjectsAddinApp::InitInstance()
{
	_Module.Init(ObjectMap, m_hInstance);
	return CWinApp::InitInstance();
}

int CBackupProjectsAddinApp::ExitInstance()
{
	_Module.Term();
...
STDAPI DllRegisterServer(void)
{
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_BACKUPPROJECTSADDIN_DESCRIPTION);
