///////////////////////////////////////////////////////////////////////////////
// $Workfile: StdAfx.h $
// $Archive: /WorkspaceWhiz/Src/Samples/ShowGroupsAddin/StdAfx.h $
...
///////////////////////////////////////////////////////////////////////////////
#if !defined(AFX_STDAFX_H__35C2CB59_DD67_445E_A784_F8C8B4182814__INCLUDED_)
#define AFX_STDAFX_H__35C2CB59_DD67_445E_A784_F8C8B4182814__INCLUDED_
...
void GetLastErrorDescription(CComBSTR& bstr);		// Defined in ShowGroupsAddin.cpp
#define VERIFY_OK(f) \
	{ \
		HRESULT hr = (f); \
		if (hr != S_OK) \
...
#endif // !defined(AFX_STDAFX_H__35C2CB59_DD67_445E_A784_F8C8B4182814__INCLUDED)
